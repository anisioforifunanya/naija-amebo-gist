...
interface CelebrityNewsClientProps {
  initialNews: NewsItem[];
}

export default function CelebrityNewsClient({ initialNews }: CelebrityNewsClientProps) {
  ...
  useEffect(() => {
    const loadNews = async () => {
      try {
        ...
        console.log('Celebrity-News: Setting newsItems to', unique.length, 'items')
        setNewsItems(unique)
      } catch (error) {
