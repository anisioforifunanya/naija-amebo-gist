      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="mt-6 sm:mt-8 border-t border-gray-700 pt-6 sm:pt-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
              <a
                href="#"
                className="flex items-center gap-1.5 sm:gap-2 bg-black hover:bg-gray-800 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg transition-colors duration-200 text-xs sm:text-sm min-h-[44px]"
                target="_blank"
        ...
        <div className="border-t border-gray-700 pt-6 sm:pt-8 text-center">
          ...
          <p className="text-gray-300 text-xs sm:text-sm">&copy; 2026 Naija Amebo Gist. All rights reserved.</p>
              ...
              <a href="https://www.instagram.com/naijaamebogist" className="text-gray-300 hover:text-white flex items-center space-x-2" target="_blank" rel="noopener noreferrer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4 text-sm md:text-base">Subscribe for breaking news and exclusives.</p>
            <input
              type="email"
        ...
        <div className="mt-8 border-t border-gray-700 pt-8">
          <div className="text-center mb-6">
            <h3 className="text-lg sm:text-xl font-semibold mb-4">Download Our App</h3>
            <p className="text-gray-300 mb-6 text-sm md:text-base">Get the latest news and updates on the go!</p>
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
              {/* Google Play Store */}
              <a
                href="#"
                className="flex items-center space-x-2 bg-black hover:bg-gray-900 text-white px-4 py-3 rounded-lg transition-colors duration-200 min-w-[140px]"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <div className="flex justify-center mb-4">
            <AlternatingLogo className="h-8 w-auto" />
          </div>
          <p className="text-gray-300">&copy; 2026 Naija Amebo Gist. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
