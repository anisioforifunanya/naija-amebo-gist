...
export const SEO_CONFIG = {
  ...
  keywords: [
    ...
    // Nigerian slang keywords (VERY IMPORTANT FOR RANKING)
    'wahala Nigeria',
    'amebo gist',
    'Nigerian online dragging',
    'trending gist Nigeria',
    'naija tea',
    'Nigerian celebrity drama',
    'Naija celebrities exposed',
    'Nigerian influencer news',
    'BBNaija news',
    'BBNaija gist',
    'Naija TikTok trending',
    'Nigerian Twitter gist',
    'Naija celebrity cheating scandal',
    'Nigerian celebrity breakup',
    'Naija celebrity wedding',
    'Nigerian celebrity baby',
    'viral Nigerian video',
    'Naija comedy news',
    'Nigerian rapper news',
    'Nigerian actress news',
    'Naija actor scandal',
  ],
